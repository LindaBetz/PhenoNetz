...
# load data
Questionnaire_Abfrage <- read_csv2("Questionnaire_Abfrage.csv", col_types = cols(
  Participant_ID = col_double(),
  Study_Day = col_character(),
  Timestamp = col_double(),
  DateTime = col_datetime(format = "%d.%m.%y %H:%M"),
  Questionnaire_of_Day = col_double(),
  `1_1_1` = col_double(),
  `2_1_1` = col_double(),
  `3_1_1` = col_double(),
  `4_1_1` = col_double(),
...
model_personalized <- data %>%
  ...
  rename_at(vars(matches("_1_1")), ~ final_vars) %>%
