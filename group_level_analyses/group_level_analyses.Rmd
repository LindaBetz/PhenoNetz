...
Participants_Study %>% 
  filter(!Participant_Code %in% c("UKK1VIZYXFWIZJIM", "UKK1VIZYNEMXSMUK", "UKK1VIZYFOOKKBDR", "UKK1VIZYIAJHBQQD", "UKK1VIZYFTXUDQQV",
                                "UKK1VIZYCAATYTOJ", "UKK1VIZYPHWVDQPA")) %>% .$Participant_ID  -> final_participants
